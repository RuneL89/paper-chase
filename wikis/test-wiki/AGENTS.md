# test-wiki — Wiki Constitution

This file is the constitution of the `test-wiki` wiki. It was generated by `chase init test-wiki` and is binding for every page in this wiki.
...
Ingestion instructions for the test-wiki wiki.
...
sources:
  - file: "wikis/test-wiki/raw/annual-report-2024.pdf"
    pages: "1-5, 47-48"
---
```
