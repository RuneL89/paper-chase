...
* `index-of-indexes.md` — the workspace-level DOX contract (Phase 6, 2026-07-20 amendment): lists every wiki that has a root `index.md`, regenerated by the DOX Writer's workspace pass at the end of every ingest; managed by the CLI — never hand-edited
