...
* `04_orchestration_detailed.md` — the five-layer ingest pipeline (Extractor, Materializer with curation, Synthesis/Amendment Writer, DOX Writer; the per-PDF loop and patch amendment amended 2026-08-26 — unimplemented until Phases 25/26) and the multilingual input/output language model (§9)
