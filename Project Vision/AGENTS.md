...
* `04_orchestration_detailed.md` — the five-layer ingest pipeline (Extractor, Materializer with curation, Synthesis/Amendment Writer, DOX Writer; the per-PDF loop and patch amendment amended 2026-08-26; worker-process isolation amended 2026-09-02/03 and fine-grained crash resume amended 2026-09-07) and the multilingual input/output language model (§9)
