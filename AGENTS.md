...
Implementation folders (`src/`, `tests/`, `test-pdfs/`, `templates/`, `prompts/`, `wikis/`) do not exist yet; index them and add child AGENTS.md files as they are created during Phase 0+.
