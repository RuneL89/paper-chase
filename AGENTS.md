...
* 2026-07-22: Model routing is multi-provider (Anthropic default, OpenAI optional; Qwen optional added 2026-08-04): Settings has a Provider row; model catalogs and inline recommendation labels follow the selected provider (Anthropic: Haiku/Sonnet/Opus; OpenAI: GPT-5.6 Luna/Terra/Sol; Qwen: Qwen-Plus/Qwen 3.7 Max/Qwen 3.8 Max); switching providers resets the four model slots to that provider's defaults; OPENAI_API_KEY / DASHSCOPE_API_KEY via env or .env.
