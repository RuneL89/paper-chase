# rkkp DHHD — Wiki Constitution

This file is the constitution of the `rkkp-dhhd` wiki. It was generated by `chase init rkkp-dhhd` and is binding for every page in this wiki.
...
Ingestion instructions for the rkkp DHHD wiki.
...
sources:
  - file: "wikis/rkkp-dhhd/raw/annual-report-2024.pdf"
    pages: "1-5, 47-48"
---
```
