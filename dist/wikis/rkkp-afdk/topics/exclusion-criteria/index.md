...
aliases:
  - Exclusion Criteria
wiki: rkkp-afdk
updated: '2026-08-15T00:26:37.476Z'
children:
  - exclusion-criteria.md
---
# Exclusion Criteria

This folder documents the methodological rules used to filter patient populations when calculating healthcare quality indicators. It covers the specific exclusion criteria applied to clinical metrics—such as removing patients who die during their primary admission—to ensure that performance measurements accurately reflect the intended scope of care and are not skewed by ineligible cases.

## Pages

- [[exclusion-criteria|Exclusion Criteria]] — Methodological rules defining which patients or cases are removed from healthcare quality indicator calculations, such as excluding in-hospital deaths from specific metrics.
