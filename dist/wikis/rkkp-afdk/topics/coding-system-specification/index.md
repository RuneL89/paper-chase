---
title: Coding System Specification
type: index
aliases:
  - Coding System Specification
wiki: rkkp-afdk
updated: '2026-08-15T00:20:51.485Z'
children:
  - coding-system-specification.md
---
# Coding System Specification

This folder contains the specific medical coding definitions used to identify clinical interventions and procedures within Danish healthcare registries. It details the exact Anatomical Therapeutic Chemical (ATC) codes used to track oral anticoagulation therapies, such as vitamin K antagonists and direct oral anticoagulants, as well as the procedural codes for various types of echocardiography recorded in the National Patient Registry. These specifications form the foundational data logic for evaluating clinical quality indicators and patient outcomes across the corpus.

## Pages

- [[coding-system-specification|Coding System Specification]] — Defines the exact ATC and procedural codes used to identify oral anticoagulation treatments and echocardiography examinations in registry data.
