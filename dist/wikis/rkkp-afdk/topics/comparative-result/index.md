...
aliases:
  - Comparative Result
wiki: rkkp-afdk
updated: '2026-08-05T23:24:46.161Z'
children:
  - comparative-result.md
---
# Comparative Result

This folder holds analyses that directly compare the clinical outcomes of different medical treatments, specifically focusing on the safety and efficacy of anticoagulant therapies. It contains registry-based evaluations measuring key quality indicators, such as the incidence of ischemic stroke among patients treated with Direct Oral Anticoagulants (DOAC) versus traditional vitamin K antagonists like Marevan. These comparative results provide the measurable evidence needed to inform clinical guidelines and assess treatment performance.

## Pages

- [[comparative-result|Comparative Result]] — Evaluates the incidence of ischemic stroke among patients treated with DOAC versus Marevan using 2024 national registry data.
