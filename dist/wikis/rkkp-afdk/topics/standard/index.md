...
aliases:
  - Standard
wiki: rkkp-afdk
updated: '2026-08-15T00:52:35.722Z'
children:
  - index.md
  - standard.md
---
...
This folder contains the conceptual framework for clinical quality standards within the Danish Atrial Fibrillation Database (AFDK). It details the specific quantitative thresholds and target benchmarks established by the AFDK steering group and the Regional Clinical Qualityity Development Program (RKKP) to define good clinical practice. The included page outlines the exact percentage targets for diagnostic tests, treatment initiation and retention, patient education, and maximum acceptable incidence rates for severe adverse events like stroke and bleeding.

## Pages

- [[standard|Standard]] — Details the exact quantitative thresholds for AFDK's clinical quality indicators, including targets for echocardiography, anticoagulation therapy, and caps on adverse events.
