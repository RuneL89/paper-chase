...
function printSummary(slug: string, result: { sourceFiles: number; documentPages: number; rawPages: number; entityPages: number; topicPages: number; warnings: string[]; errors: string[]; added: string[]; changed: string[]; removed: string[] }): void {
