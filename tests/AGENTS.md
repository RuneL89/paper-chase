...
* `npm test` green in both modes: without a key — 154 passed + 13 self-skipped (12 live Phase 2 gates + Phase 0 gate 0.4); with the key (`.env` at project root) — 166 passed + 1 skipped (gate 0.4 keeps its Phase 0 exported-var-only behavior, verified separately 5/5). Counts verified 2026-07-18 after Phase 6 added 3 tests to `phase-06.test.ts`
